...
abstract class CApplication extends CModule
{
	 ...
	 * 
	 * ### Update Jun 2013
	 * Add $ComponentName for multiple connection, by default as 'db'
	 * define Component in config/main.php
	 * reguired item class => CDbConnection
	 */
	public function getDb($ComponentName = 'db')
	{
