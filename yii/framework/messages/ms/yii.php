...
return array (
  ...
  'Please fix the following input errors:' => 'Harap maaf, terdapat kesalahan input seperti berikut:',
  ...
  '{attribute} cannot be blank.' => 'Sila masukkan maklumat {attribute}.',
  ...
  '{attribute} is not a valid email address.' => 'Sila masukkan alamat emel yang sah.',
  '{attribute} is not in the list.' => '{attribute} tidak di dalam lst.',
  '{attribute} is of the wrong length (should be {length} characters).' => 'Panjang {attribute} salah (seharusnya {length} aksara).',
  '{attribute} is too big (maximum is {max}).' => '{attribute} terlalu besar (maksimum {max}).',
  '{attribute} is too long (maximum is {max} characters).' => '{attribute} terlalu panjang (maksimum {max} aksara).',
  '{attribute} is too short (minimum is {min} characters).' => '{attribute} terlalu pendek (minimum {min} aksara).',
