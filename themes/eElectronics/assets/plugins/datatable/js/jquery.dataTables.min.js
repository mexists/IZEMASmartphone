		...
		var j = function (e) {
			...
			function ua(a) {
				...
				if (0 !== a.aoRowCreatedCallback.length) {
					b = 0;
					for (c = a.aoData.length; b < c; b++)f = a.aoData[b], A(a, "aoRowCreatedCallback", null, [f.nTr,
						f._aData, b])
				}
			}
			...
			function x(a) {
				...
				if (-1 !== h.inArray(!1, b))E(a, !1); else {
					...
					A(a, "aoHeaderCallback", "header", [h(a.nTHead).children("tr")[0], Z(a), a._iDisplayStart,
				...
				Ra(b, {}, function (b) {
					if (!1 !== a.aoColumns[c].bSortable) {
						var e = function () {
							...
							} else 1 == a.aaSorting.length && a.aaSorting[0][0] == c ? (d = a.aaSorting[0][0], e = a.aaSorting[0][2] + 1, a.aoColumns[d].asSorting[e] || (e = 0), a.aaSorting[0][1] = a.aoColumns[d].asSorting[e], a.aaSorting[0][2] = e) : (a.aaSorting.splice(0, a.aaSorting.length), a.aaSorting.push([c,
			...
			this.fnGetPosition = function (a) {
				...
				return "TR" == c ? I(b, a) : "TD" == c || "TH" == c ? (c = I(b, a.parentNode), a = fa(b, c, a), [c,
					R(b, a), a]) : null
			};
			...
			two_button: {
				...
				fnUpdate: function (e, o) {
					if (e.aanFeatures.p) {
						...
						m = 0;
						for (k = M.length; m < k; m++)u = M[m], u.hasChildNodes() && (h("span:eq(0)", u).html(t).children("a").each(L), u = u.getElementsByTagName("a"), u = [u[0],
							u[1], u[u.length - 2],
							u[u.length - 1]], h(u).removeClass(B.sPageButton + " " + B.sPageButtonActive + " " + B.sPageButtonStaticDisabled), h([u[0],
							u[1]]).addClass(1 == n ? B.sPageButtonStaticDisabled :
							B.sPageButton), h([u[2],
							u[3]]).addClass(0 === l || n === l || -1 === e._iDisplayLength ? B.sPageButtonStaticDisabled : B.sPageButton))
					}
				}
			}
		});
