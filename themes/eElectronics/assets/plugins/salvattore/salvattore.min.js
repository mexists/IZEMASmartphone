 ...
 */
!function (a, b) {
	"object" == typeof exports ? module.exports = b() : "function" == typeof define && define.amd ? define("salvattore", [], b) : a.salvattore = b()
}(this, function () {
	window.matchMedia || (window.matchMedia = function () {
		...
		var a = window.matchMedia, b = a("only all").matches, c = !1, d = 0, e = [], f = function () {
			clearTimeout(d), d = setTimeout(function () {
				for (var b = 0, c = e.length; c > b; b++) {
					var d = e[b].mql, f = e[b].listeners || [], g = a(d.media).matches;
					if (g !== d.matches) {
						d.matches = g;
		...
		for (var a = 0, b = ["ms", "moz", "webkit",
			"o"], c = 0; c < b.length && !window.requestAnimationFrame; ++c)window.requestAnimationFrame = window[b[c] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[b[c] + "CancelAnimationFrame"] || window[b[c] + "CancelRequestAnimationFrame"];
	...
	var a = function (a, b) {
		...
		return c.obtain_grid_settings = function (b) {
			var c, d, e = a.getComputedStyle(b, ":before"), f = e.getPropertyValue("content").slice(1, -1), g = f.match(/^\s*(\d+)(?:\s?\.(.+))?\s*$/);
			...
			j.forEach(function (a) {
				var c = b.createElement("div"), d = b.createDocumentFragment();
			...
			}), g = f.length, h = f[0].childNodes.length, i = new Array(h * g);
			...
			for (var b, c = a.length; c--;)if (b = a[c], b.selectorText && b.selectorText.match(/\[data-columns\](.*)::?before$/))return !0;
			return !1
			...
			a.matchMedia && (c.get_stylesheets().forEach(function (d) {
				Array.prototype.forEach.call(c.get_css_rules(d), function (d) {
					d.media && c.media_rule_has_columns_selector(d.cssRules) && b.push(a.matchMedia(d.media.mediaText))
				})
			}), b.forEach(function (a) {
				a.addListener(c.media_query_change)
			}))
		}, c.next_element_column_index = function (a, b) {
			var c, d, e, f = a.children, g = f.length, h = 0, i = 0;
			for (e = 0; g > e; e++)c = f[e], d = c.children.length + b[e].children.length, 0 === h && (h = d), h > d && (i = e, h = d);
			return i
			...
			var d = a.children, e = d.length, f = c.create_list_of_fragments(e);
			...
			var e = a.children, f = e.length, g = c.create_list_of_fragments(f), h = f - 1;
