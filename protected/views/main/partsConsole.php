<?php $this->pageTitle = "Game Console Parts"; ?>
<style>
    div.clear {
        clear: both;
    }
...
<div class="container">
    ...
    <div class="row form-group product-chooser">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <a href="<?=$this->createUrl('Microsoft')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Console/xbox.png"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Microsoft">

                    <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                        <h2 class="text-center">Microsoft</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <a href="<?=$this->createUrl('Nintendo')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Console/wii.png"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Nintendo">

                    <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                        <h2 class="text-center">Nintendo</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <a href="<?=$this->createUrl('Sony')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Console/ps3.png"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Sony">
