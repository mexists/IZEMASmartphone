								...
								<tr class="cart_item">
									...
									<td class="product-thumbnail">
										<a href="single-product.html"><img width="145" height="145" alt="poster_1_up"
										                                   ...
										                                   src="<?= $this->getThemePath() ?>assets/img/product-thumb-2.jpg"></a>
									</td>
								...
								<ul class="products">
									<li class="product">
										<a href="single-product.html">
											<img width="325" height="325" alt="T_4_front"
											     ...
											     src="<?= $this->getThemePath() ?>assets/img/product-2.jpg">
										...
										<a class="add_to_cart_button" data-quantity="1" data-product_sku=""
										   ...
										   href="single-product.html">Select options</a>
									</li>
									...
									<li class="product">
										<a href="single-product.html">
											<img width="325" height="325" alt="T_4_front"
											     class="attachment-shop_catalog wp-post-image"
											     src="<?= $this->getThemePath() ?>assets/img/product-4.jpg">
