...
<div class="container">
    ...
    <div class="row form-group product-chooser">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <a href="<?=$this->createUrl('Macbook')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Mac/macbook.png"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="MacBook">

                    <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                        <h2 class="text-center">MacBook Parts</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <a href="<?=$this->createUrl('MacbookAir')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Mac/macbookair.png"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="MacBook Air">

                    <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                        <h2 class="text-center">MacBook Air Parts</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <a href="<?=$this->createUrl('MacbookPro')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Mac/macbookpro.png"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Macbook pro">

                    <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                        <h2 class="text-center">MacBook Pro Parts</h2>
