...
<div class="container">
    ...
    <div class="product-breadcroumb">
        ...
        <a href="<?=$this->createUrl('MacbookAir')?>">MacBook Air</a>
    </div>
    ...
    <div class="row form-group product-chooser">
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <a href="<?=$this->createUrl('MacBookAir11')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Mac//MacBookAir/MacBookAir11.standard"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt='11" MacBook Air'>

                    <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                        <h2 class="text-center title">11"</h2>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <a href="<?=$this->createUrl('MacBookAir13')?>">
                <div class="product-chooser-item">
                    <img src="<?= Yii::app()->baseUrl ?>/images/Mac//MacBookAir/MacBookAir13.standard"
                         class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt='13" MacBook Air'>
