			...
			<div class="col-md-8">
				<div class="product-content-right">
					<div class="woocommerce">
						<form enctype="multipart/form-data" action="<?=$this->createUrl('CreateApplication')?>" class="checkout" method="post" name="checkout">
									...
									<div class="woocommerce-shipping-fields">
										...
										<div class="shipping_address" style="display: none;">
											<p id="shipping_country_field"
											   class="hidden form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
												<label class="" for="shipping_country">Country <abbr title="required"
												                                                     class="required">*</abbr>
												</label>
												<select class="country_to_state country_select" id="shipping_country"
												        name="Application[shipping_country]">
													<option value="">Select a country…</option>
													<option value="AX">Åland Islands</option>
													<option value="AF">Afghanistan</option>
													<option value="AL">Albania</option>
											...
											<p id="shipping_first_name_field"
											   class="form-row form-row-first validate-required">
												...
												<input type="text" value="" placeholder="" id="shipping_first_name"
												       name="Application[shipping_first_name]" class="input-text ">
											</p>
											...
											<p id="shipping_last_name_field"
											   class="form-row form-row-last validate-required">
												...
												<input type="text" value="" placeholder="" id="shipping_last_name"
												       name="Application[shipping_last_name]" class="input-text ">
											</p>
											...
											<p id="shipping_company_field" class="form-row form-row-wide">
												...
												<input type="text" value="" placeholder="" id="shipping_company"
												       name="Application[shipping_company]" class="input-text ">
											</p>

											<p id="shipping_address_1_field"
											   class="form-row form-row-wide address-field validate-required">
												<label class="" for="shipping_address_1">Address <abbr title="required"
												                                                       class="required">*</abbr>
												</label>
												<input type="text" value="" placeholder="Street address"
												       id="shipping_address_1" name="Application[shipping_address_1]"
												       class="input-text ">
											</p>
											...
											<p id="shipping_address_2_field"
											   class="form-row form-row-wide address-field">
												<input type="text" value=""
												       placeholder="Apartment, suite, unit etc. (optional)"
												       id="shipping_address_2" name="Application[shipping_address_2]"
												       class="input-text ">
											</p>
											...
											<p id="shipping_city_field"
											   class="form-row form-row-wide address-field validate-required"
											   data-o_class="form-row form-row-wide address-field validate-required">
												<label class="" for="shipping_city">Town / City <abbr title="required"
												                                                      class="required">*</abbr>
												</label>
												<input type="text" value="" placeholder="Town / City" id="shipping_city"
												       name="Application[shipping_city]" class="input-text ">
											</p>
											...
											<p id="shipping_state_field"
											   ...
											   data-o_class="form-row form-row-first address-field validate-state">
												...
												<input type="text" id="shipping_state" name="Application[shipping_state]"
												       placeholder="State / County" value="" class="input-text ">
											</p>
											...
											<p id="shipping_postcode_field"
											   class="form-row form-row-last address-field validate-required validate-postcode"
											   data-o_class="form-row form-row-last address-field validate-required validate-postcode">
												<label class="" for="shipping_postcode">Postcode <abbr title="required"
												                                                       class="required">*</abbr>
												</label>
												<input type="text" value="" placeholder="Postcode / Zip"
												       id="shipping_postcode" name="Application[shipping_postcode]"
												       class="input-text ">
											</p>
										...
										<p id="order_comments_field" class="form-row notes">
											...
											<textarea cols="5" rows="2"
											          ...
											          name="Application[order_comments]"></textarea>
										</p>
							...
							<div id="order_review" style="position: relative;">
								<table class="shop_table">
										...
										foreach (Yii::app()->session['carts'] as $model_id => $quantity):
											...
											<tr class="cart_item">
												<td class="product-name">
													<?= "{$BrandModel->brand->name} {$BrandModel->name}" ?> <strong class="product-quantity">× <?= $quantity ?></strong></td>
												<td class="product-total">
													<span class="amount">RM<?= $total ?></span></td>
											</tr>
										<?php
										endforeach;
									?>
									...
									<tr class="cart-subtotal">
										<th>Cart Subtotal</th>
										<td><span class="amount">RM<?= $subtotal ?></span>
										</td>
									</tr>
									...
									<tr class="shipping">
										...
										<td>
											...
											<input type="hidden" class="shipping_method" value="free_shipping"
											       id="shipping_method_0" data-index="0" name="Application[shipping_method][0]">
										</td>
									</tr>
									...
									<ul class="payment_methods methods">
										<li class="payment_method_bacs">
											<input type="radio" data-order_button_text="" checked="checked" value="bacs"
											       name="Application[payment_method]" class="input-radio" id="payment_method_bacs">
										...
										<li class="payment_method_cheque hidden">
										...
										<li class="payment_method_paypal hidden">
